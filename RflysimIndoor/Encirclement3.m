function [u,ux,uy,uyaw,leader_locate,dist]  = Encirclement3(p_leader,tunnel_left,tunnel_right,p_target,Pcur,Vcur,Yawcur,gain,vmax,rs,ra,i)
N=6;
...
%     ksii = Pcur(i,1:2) + 1/gain*Vcur(i,1:2);
    ...
    dVtidksiti=k3*dmysigma2(rtksii-norm(ksiti),rs,ra,emt);
