...
class Px4Controller:
    ...
    def start(self):
        ...
        while (rospy.is_shutdown() is False):
            ...
            direct_obs = (self.feb_bias_pos.y - self.obs.y)/abs(self.feb_bias_pos.y - self.obs.y)
            if abs(self.feb_bias_pos.y - self.obs.y) < 8 and self.drone_id == 3:
                self.obs_vel.x = direct_obs * 0.6
